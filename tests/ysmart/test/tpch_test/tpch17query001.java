...
public class tpch17query001 extends Configured implements Tool{
	...
	public static class Map extends Mapper<Object, Text,Text,Text>{
		...
		public void map(Object key, Text value, Context context) throws IOException,InterruptedException{
			...
			if(adv_gb_output[0].containsKey(hash_key)){
				Double sum_tmp = (double)Double.parseDouble(line_buf[1]);
				sum_tmp += adv_gb_output[0].get(hash_key);
				adv_gb_output[0].put(hash_key, sum_tmp);
			}else{
				adv_gb_output[0].put(hash_key,(double)Double.parseDouble(line_buf[1]));
			}
		}
	...
	public static class Reduce extends Reducer<Text,Text,NullWritable,Text>{
		...
		public void reduce(Text key, Iterable<Text> v, Context context) throws IOException,InterruptedException{
			...
			context.write(key_op,new Text(((result[0]) /  7.0) + "|"));
		}
	...
	public int run(String[] args) throws Exception{
		...
		Job job = new Job(conf,"tpch17query001");
		job.setJarByClass(tpch17query001.class);
	...
	public static void main(String[] args) throws Exception {
			...
			int res = ToolRunner.run(new Configuration(), new tpch17query001(), args);
			System.exit(res);
	}
