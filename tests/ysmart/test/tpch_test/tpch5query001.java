...
public class tpch5query001 extends Configured implements Tool{
	...
	public static class Map extends  Mapper<Object, Text,Text,Text>{
		...
		public void map(Object key, Text value, Context context) throws IOException,InterruptedException{
			...
			if(n<3)
				line_buf[n] = line.substring(prev,i);
			context.write(new Text(line_buf[0] +"|"),new Text(line_buf[1] +"|"+line_buf[2] +"|"));
		}
	...
	public int run(String[] args) throws Exception{
		...
		Job job = new Job(conf, "tpch5query001");
		job.setJarByClass(tpch5query001.class);
	...
	public static void main(String[] args) throws Exception {
		...
		int res = ToolRunner.run(new Configuration(), new tpch5query001(),args);
		System.exit(res);
	}
