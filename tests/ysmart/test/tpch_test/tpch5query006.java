...
package edu.osu.cse.ysmart.tpch5query;
...
public class tpch5query006 extends Configured implements Tool{
	...
	public static class Map extends  Mapper<Object, Text,IntWritable,Text>{
		...
		public void setup(Context context) throws IOException, InterruptedException {
			...
			if(f_name.compareTo("tpch5query007") == 0 )
				left = 1;
		}
		public void map(Object key, Text value,Context context) throws IOException,InterruptedException{
			...
			if(n<2)
				line_buf[n] = line.substring(prev,i);
				context.write(new IntWritable(Integer.parseInt(line_buf[1])), new Text("L"+"|" +line_buf[0]+ "|"+line_buf[1]+ "|"));
			}else{
			...
			if(n<7)
				line_buf[n] = line.substring(prev,i);
				context.write(new IntWritable(Integer.parseInt(line_buf[0])), new Text("R"+"|" +Double.parseDouble(line_buf[5])+ "|" +Double.parseDouble(line_buf[6])+ "|" +Integer.parseInt(line_buf[2])+ "|" +Integer.parseInt(line_buf[0])+ "|" ));
			}
		...
		public void reduce(IntWritable key, Iterable<Text> v, Context context) throws IOException,InterruptedException{
			...
			for(int i=0;i<al_left.size();i++){
				...
				for(int j=0;j<al_right.size();j++){
					...
					context.write(key_op, new Text(Double.parseDouble(right_buf[0])+ "|" +Double.parseDouble(right_buf[1])+ "|" +Integer.parseInt(right_buf[2])+ "|" +Integer.parseInt(left_buf[0])+ "|" ));
				}
	...
	public int run(String[] args) throws Exception{
		...
		Job job = new Job(conf,"tpch5query006");
		job.setJarByClass(tpch5query006.class);
	...
	public static void main(String[] args) throws Exception {
			...
			int res = ToolRunner.run(new Configuration(), new tpch5query006(), args);
			System.exit(res);
	}
