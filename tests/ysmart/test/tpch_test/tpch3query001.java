...
public class tpch3query001 extends Configured implements Tool{
	...
	public int run(String[] args) throws Exception{
		...
		Job job = new Job(conf, "tpch3query001");
		job.setJarByClass(tpch3query001.class);
	...
	public static void main(String[] args) throws Exception {
		...
		int res = ToolRunner.run(new Configuration(), new tpch3query001(),args);
		System.exit(res);
	}
