...
public class tpch10query003 extends Configured implements Tool{
	...
	public static class Map extends  Mapper<Object, Text,IntWritable,Text>{
		...
		public void setup(Context context) throws IOException, InterruptedException {
			...
			if(f_name.compareTo("tpch10query004") == 0 )
				left = 1;
		}
		public void map(Object key, Text value,Context context) throws IOException,InterruptedException{
			...
			if(n<9)
				line_buf[n] = line.substring(prev,i);
				context.write(new IntWritable(Integer.parseInt(line_buf[8])), new Text("L"+"|" +line_buf[0]+ "|"+line_buf[1]+ "|"+line_buf[2]+ "|"+line_buf[3]+ "|"+line_buf[4]+ "|"+line_buf[5]+ "|"+line_buf[6]+ "|"+line_buf[7]+ "|"+line_buf[8]+ "|"));
			}else{
			...
			if(n<2)
				line_buf[n] = line.substring(prev,i);
				context.write(new IntWritable(Integer.parseInt(line_buf[0])), new Text("R"+"|" +line_buf[1]+ "|" +Integer.parseInt(line_buf[0])+ "|" ));
			}
		...
		public void reduce(IntWritable key, Iterable<Text> v, Context context) throws IOException,InterruptedException{
			...
			for(int i=0;i<al_left.size();i++){
				...
				for(int j=0;j<al_right.size();j++){
					...
					context.write(key_op, new Text(Integer.parseInt(left_buf[0])+ "|" +left_buf[1]+ "|" +Double.parseDouble(left_buf[2])+ "|" +left_buf[3]+ "|" +right_buf[0]+ "|" +left_buf[4]+ "|" +left_buf[5]+ "|" +Double.parseDouble(left_buf[6])+ "|" +Double.parseDouble(left_buf[7])+ "|" ));
				}
	...
	public int run(String[] args) throws Exception{
		...
		Job job = new Job(conf,"tpch10query003");
		job.setJarByClass(tpch10query003.class);
	...
	public static void main(String[] args) throws Exception {
			...
			int res = ToolRunner.run(new Configuration(), new tpch10query003(), args);
			System.exit(res);
	}
