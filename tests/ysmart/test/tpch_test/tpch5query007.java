...
public class tpch5query007 extends Configured implements Tool{
	...
	public static class Map extends  Mapper<Object, Text,IntWritable,Text>{
		...
		public void map(Object key, Text value,Context context) throws IOException,InterruptedException{
			...
			if(n<4)
				line_buf[n] = line.substring(prev,i);
				context.write(new IntWritable(Integer.parseInt(line_buf[0])), new Text("L"+"|" +Integer.parseInt(line_buf[3])+ "|" +Integer.parseInt(line_buf[0])+ "|" ));
			}else{
			...
			if(n<5)
				line_buf[n] = line.substring(prev,i);
				if(line_buf[4].compareTo("1994-01-01") >= 0 && line_buf[4].compareTo("1995-01-01") < 0){
		...
		public void reduce(IntWritable key, Iterable<Text> v, Context context) throws IOException,InterruptedException{
			...
			for(int i=0;i<al_left.size();i++){
				...
				for(int j=0;j<al_right.size();j++){
					...
					context.write(key_op, new Text(Integer.parseInt(left_buf[0])+ "|" +Integer.parseInt(right_buf[0])+ "|" ));
				}
	...
	public int run(String[] args) throws Exception{
		...
		Job job = new Job(conf,"tpch5query007");
		job.setJarByClass(tpch5query007.class);
	...
	public static void main(String[] args) throws Exception {
			...
			int res = ToolRunner.run(new Configuration(), new tpch5query007(), args);
			System.exit(res);
	}
