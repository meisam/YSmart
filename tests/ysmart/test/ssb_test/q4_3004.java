...
public class q4_3004 extends Configured implements Tool{
	...
	public static class Map extends  Mapper<Object, Text,IntWritable,Text>{
		...
		public void map(Object key, Text value,Context context) throws IOException,InterruptedException{
			...
			if(n<5)
				line_buf[n] = line.substring(prev,i);
				if(line_buf[4].compareTo("UNITED STATES") == 0){

					context.write(new IntWritable(Integer.parseInt(line_buf[0])), new Text("R"+"|" +line_buf[3]+ "|" +Integer.parseInt(line_buf[0])+ "|" ));
				}
			}
			...
			for(int i=0;i<al_left.size();i++){
				...
				for(int j=0;j<al_right.size();j++){
					...
					if(Integer.parseInt(left_buf[0]) == 1997 || Integer.parseInt(left_buf[0]) == 1998){
						...
						context.write(key_op, new Text(Integer.parseInt(left_buf[0])+ "|" +right_buf[0]+ "|" +Double.parseDouble(left_buf[1])+ "|" +Double.parseDouble(left_buf[2])+ "|" +Integer.parseInt(left_buf[3])+ "|" ));
					}
				}
	...
	public int run(String[] args) throws Exception{
		...
		Job job = new Job(conf,"q4_3004");
		job.setJarByClass(q4_3004.class);
	...
	public static void main(String[] args) throws Exception {
			...
			int res = ToolRunner.run(new Configuration(), new q4_3004(), args);
			System.exit(res);
	}
