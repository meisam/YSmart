...
public class q4_2001 extends Configured implements Tool{
	...
	public static class Map extends  Mapper<Object, Text,Text,Text>{
		...
		public void map(Object key, Text value, Context context) throws IOException,InterruptedException{
			...
			if(n<7)
				line_buf[n] = line.substring(prev,i);
			context.write(new Text(line_buf[0] +"|"+line_buf[1] +"|"+line_buf[2] +"|"),new Text(line_buf[3] +"|"+line_buf[4] +"|"+line_buf[5] +"|"+line_buf[6] +"|"));
		}
	...
	public int run(String[] args) throws Exception{
		...
		conf.set("mapreduce.partition.keycomparator.options","-k1,1n -k2,2 -k3,3 ");
		conf.set("mapreduce.map.output.key.field.separator", "|");
		Job job = new Job(conf, "q4_2001");
		job.setJarByClass(q4_2001.class);
	...
	public static void main(String[] args) throws Exception {
		...
		int res = ToolRunner.run(new Configuration(), new q4_2001(),args);
		System.exit(res);
	}
