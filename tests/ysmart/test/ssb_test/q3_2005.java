...
package edu.osu.cse.ysmart.q3_2;
...
public class q3_2005 extends Configured implements Tool{
	...
	public int run(String[] args) throws Exception{
		...
		Job job = new Job(conf,"q3_2005");
		job.setJarByClass(q3_2005.class);
	...
	public static void main(String[] args) throws Exception {
			...
			int res = ToolRunner.run(new Configuration(), new q3_2005(), args);
			System.exit(res);
	}
