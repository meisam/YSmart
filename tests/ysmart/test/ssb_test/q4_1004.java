...
public class q4_1004 extends Configured implements Tool{
		...
		public void reduce(IntWritable key, Iterable<Text> v, Context context) throws IOException,InterruptedException{
			...
			for(int i=0;i<al_left.size();i++){
				...
				for(int j=0;j<al_right.size();j++){
					...
					context.write(key_op, new Text(Integer.parseInt(left_buf[0])+ "|" +left_buf[1]+ "|" +Double.parseDouble(left_buf[2])+ "|" +Double.parseDouble(left_buf[3])+ "|" +Integer.parseInt(left_buf[4])+ "|" ));
				}
	...
	public int run(String[] args) throws Exception{
		...
		Job job = new Job(conf,"q4_1004");
		job.setJarByClass(q4_1004.class);
	...
	public static void main(String[] args) throws Exception {
			...
			int res = ToolRunner.run(new Configuration(), new q4_1004(), args);
			System.exit(res);
	}
