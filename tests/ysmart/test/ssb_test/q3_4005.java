...
public class q3_4005 extends Configured implements Tool{
	...
	public static class Map extends  Mapper<Object, Text,IntWritable,Text>{
		...
		public void map(Object key, Text value,Context context) throws IOException,InterruptedException{
			...
			if(n<4)
				line_buf[n] = line.substring(prev,i);
				if(line_buf[3].compareTo("UNITED KI1") == 0 || line_buf[3].compareTo("UNITED KI5") == 0){

					context.write(new IntWritable(Integer.parseInt(line_buf[0])), new Text("L"+"|"+line_buf[3]+ "|" +Integer.parseInt(line_buf[0])+ "|" ));
				}
			}else{

				String[] line_buf = new String[13];
				for(i=0,n=0,prev=0;i<line.length();i++){
			...
			if(n<13)
				line_buf[n] = line.substring(prev,i);
				context.write(new IntWritable(Integer.parseInt(line_buf[2])), new Text("R"+"|" +Double.parseDouble(line_buf[12])+ "|" +line_buf[5]+ "|" +Integer.parseInt(line_buf[4])+ "|" +Integer.parseInt(line_buf[2])+ "|" ));
			}
		...
		public void reduce(IntWritable key, Iterable<Text> v, Context context) throws IOException,InterruptedException{
			...
			for(int i=0;i<al_left.size();i++){
				...
				for(int j=0;j<al_right.size();j++){
					...
					if(left_buf[0].compareTo("UNITED KI1") == 0 || left_buf[0].compareTo("UNITED KI5") == 0){

						context.write(key_op, new Text(left_buf[0]+ "|" +Double.parseDouble(right_buf[0])+ "|" +right_buf[1]+ "|" +Integer.parseInt(right_buf[2])+ "|" ));
					}
				}
	...
	public int run(String[] args) throws Exception{
		...
		Job job = new Job(conf,"q3_4005");
		job.setJarByClass(q3_4005.class);
	...
	public static void main(String[] args) throws Exception {
			...
			int res = ToolRunner.run(new Configuration(), new q3_4005(), args);
			System.exit(res);
	}
