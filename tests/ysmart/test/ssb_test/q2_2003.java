...
public class q2_2003 extends Configured implements Tool{
	...
	public int run(String[] args) throws Exception{
		...
		Job job = new Job(conf,"q2_2003");
		job.setJarByClass(q2_2003.class);
	...
	public static void main(String[] args) throws Exception {
			...
			int res = ToolRunner.run(new Configuration(), new q2_2003(), args);
			System.exit(res);
	}
