...
public class q4_1006 extends Configured implements Tool{
		...
		public void reduce(Text key, Iterable<Text> v, Context context) throws IOException,InterruptedException{
			...
			for(int i=0;i<al_left.size();i++){
				...
				for(int j=0;j<al_right.size();j++){
					...
					if(left_buf[5].compareTo(right_buf[1]) == 0){
	...
	public int run(String[] args) throws Exception{
		...
		Job job = new Job(conf,"q4_1006");
		job.setJarByClass(q4_1006.class);
	...
	public static void main(String[] args) throws Exception {
			...
			int res = ToolRunner.run(new Configuration(), new q4_1006(), args);
			System.exit(res);
	}
