...
public class q3_1005 extends Configured implements Tool{
	...
	public static class Map extends  Mapper<Object, Text,IntWritable,Text>{
		...
		public void map(Object key, Text value,Context context) throws IOException,InterruptedException{
			...
			if(n<6)
				line_buf[n] = line.substring(prev,i);
				if(line_buf[5].compareTo("ASIA") == 0){

					context.write(new IntWritable(Integer.parseInt(line_buf[0])), new Text("L"+"|"+line_buf[4]+ "|" +Integer.parseInt(line_buf[0])+ "|" ));
				}
			}else{
	...
	public int run(String[] args) throws Exception{
		...
		Job job = new Job(conf,"q3_1005");
		job.setJarByClass(q3_1005.class);
	...
	public static void main(String[] args) throws Exception {
			...
			int res = ToolRunner.run(new Configuration(), new q3_1005(), args);
			System.exit(res);
	}
