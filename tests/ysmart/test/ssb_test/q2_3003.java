...
public class q2_3003 extends Configured implements Tool{
	...
	public static class Map extends  Mapper<Object, Text,IntWritable,Text>{
		...
		public void map(Object key, Text value,Context context) throws IOException,InterruptedException{
			...
			if(n<6)
				line_buf[n] = line.substring(prev,i);
				if(line_buf[5].compareTo("EUROPE") == 0){
	...
	public int run(String[] args) throws Exception{
		...
		Job job = new Job(conf,"q2_3003");
		job.setJarByClass(q2_3003.class);
	...
	public static void main(String[] args) throws Exception {
			...
			int res = ToolRunner.run(new Configuration(), new q2_3003(), args);
			System.exit(res);
	}
