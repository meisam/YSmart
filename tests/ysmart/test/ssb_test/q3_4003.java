...
public class q3_4003 extends Configured implements Tool{
	...
	public static class Map extends  Mapper<Object, Text,Text,Text>{
		...
		public void map(Object key, Text value,Context context) throws IOException,InterruptedException{
			...
			if(n<7)
				line_buf[n] = line.substring(prev,i);
				if(line_buf[6].compareTo("Dec1997") == 0){
		...
		public void reduce(Text key, Iterable<Text> v, Context context) throws IOException,InterruptedException{
			...
			for(int i=0;i<al_left.size();i++){
				...
				for(int j=0;j<al_right.size();j++){
					...
					if(left_buf[0].compareTo("UNITED KI1") == 0 || left_buf[0].compareTo("UNITED KI5") == 0 && left_buf[1].compareTo("UNITED KI1") == 0 || left_buf[1].compareTo("UNITED KI5") == 0){
	...
	public int run(String[] args) throws Exception{
		...
		Job job = new Job(conf,"q3_4003");
		job.setJarByClass(q3_4003.class);
	...
	public static void main(String[] args) throws Exception {
			...
			int res = ToolRunner.run(new Configuration(), new q3_4003(), args);
			System.exit(res);
	}
