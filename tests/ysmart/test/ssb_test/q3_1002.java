...
public class q3_1002 extends Configured implements Tool{
	...
	public int run(String[] args) throws Exception{
		...
		Job job = new Job(conf,"q3_1002");
		job.setJarByClass(q3_1002.class);
	...
	public static void main(String[] args) throws Exception {
			...
			int res = ToolRunner.run(new Configuration(), new q3_1002(), args);
			System.exit(res);
	}
