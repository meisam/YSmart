...
public class q4_3005 extends Configured implements Tool{
	...
	public int run(String[] args) throws Exception{
		...
		Job job = new Job(conf,"q4_3005");
		job.setJarByClass(q4_3005.class);
	...
	public static void main(String[] args) throws Exception {
			...
			int res = ToolRunner.run(new Configuration(), new q4_3005(), args);
			System.exit(res);
	}
