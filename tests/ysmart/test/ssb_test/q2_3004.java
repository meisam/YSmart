...
public class q2_3004 extends Configured implements Tool{
	...
	public static class Map extends  Mapper<Object, Text,IntWritable,Text>{
		...
		public void map(Object key, Text value,Context context) throws IOException,InterruptedException{
			...
			if(n<5)
				line_buf[n] = line.substring(prev,i);
				if(line_buf[4].compareTo("MFGR#2239") == 0){
	...
	public int run(String[] args) throws Exception{
		...
		Job job = new Job(conf,"q2_3004");
		job.setJarByClass(q2_3004.class);
	...
	public static void main(String[] args) throws Exception {
			...
			int res = ToolRunner.run(new Configuration(), new q2_3004(), args);
			System.exit(res);
	}
