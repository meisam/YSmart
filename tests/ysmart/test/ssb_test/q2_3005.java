...
package edu.osu.cse.ysmart.q2_3;
...
public class q2_3005 extends Configured implements Tool{
	...
	public int run(String[] args) throws Exception{
		...
		Job job = new Job(conf,"q2_3005");
		job.setJarByClass(q2_3005.class);
	...
	public static void main(String[] args) throws Exception {
			...
			int res = ToolRunner.run(new Configuration(), new q2_3005(), args);
			System.exit(res);
	}
