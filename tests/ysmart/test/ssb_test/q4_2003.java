...
package edu.osu.cse.ysmart.q4_2;
...
public class q4_2003 extends Configured implements Tool{
	...
	public static class Map extends  Mapper<Object, Text,IntWritable,Text>{
		...
		public void map(Object key, Text value,Context context) throws IOException,InterruptedException{
			...
			if(n<4)
				line_buf[n] = line.substring(prev,i);
				if(line_buf[2].compareTo("MFGR#1") == 0 || line_buf[2].compareTo("MFGR#2") == 0){

					context.write(new IntWritable(Integer.parseInt(line_buf[0])), new Text("R"+"|" +line_buf[3]+ "|" +line_buf[2]+ "|" +Integer.parseInt(line_buf[0])+ "|" ));
				}
			}
		...
		public void reduce(IntWritable key, Iterable<Text> v, Context context) throws IOException,InterruptedException{
			...
			for(int i=0;i<al_left.size();i++){
				...
				for(int j=0;j<al_right.size();j++){
					...
					if(Integer.parseInt(left_buf[0]) == 1997 || Integer.parseInt(left_buf[0]) == 1998 && right_buf[1].compareTo("MFGR#1") == 0 || right_buf[1].compareTo("MFGR#2") == 0){
	...
	public int run(String[] args) throws Exception{
		...
		Job job = new Job(conf,"q4_2003");
		job.setJarByClass(q4_2003.class);
	...
	public static void main(String[] args) throws Exception {
			...
			int res = ToolRunner.run(new Configuration(), new q4_2003(), args);
			System.exit(res);
	}
