...
public class q4_1003 extends Configured implements Tool{
		...
		public void map(Object key, Text value,Context context) throws IOException,InterruptedException{
			...
			if(n<3)
				...
				if(line_buf[2].compareTo("MFGR#1") == 0 || line_buf[2].compareTo("MFGR#2") == 0){
					...
					context.write(new IntWritable(Integer.parseInt(line_buf[0])), new Text("R"+"|" +line_buf[2]+ "|" +Integer.parseInt(line_buf[0])+ "|" ));
				}
			}
		...
		public void reduce(IntWritable key, Iterable<Text> v, Context context) throws IOException,InterruptedException{
			...
			for(int i=0;i<al_left.size();i++){
				...
				for(int j=0;j<al_right.size();j++){
					...
					if(right_buf[0].compareTo("MFGR#1") == 0 || right_buf[0].compareTo("MFGR#2") == 0){

						context.write(key_op, new Text(Integer.parseInt(left_buf[0])+ "|" +left_buf[1]+ "|" +Double.parseDouble(left_buf[2])+ "|" +Double.parseDouble(left_buf[3])+ "|" ));
					}
				}
	...
	public int run(String[] args) throws Exception{
		...
		Job job = new Job(conf,"q4_1003");
		job.setJarByClass(q4_1003.class);
	...
	public static void main(String[] args) throws Exception {
			...
			int res = ToolRunner.run(new Configuration(), new q4_1003(), args);
			System.exit(res);
	}
