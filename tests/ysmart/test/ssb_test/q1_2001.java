...
package edu.osu.cse.ysmart.q1_2;
...
public class q1_2001 extends Configured implements Tool{
	...
	public int run(String[] args) throws Exception{
		...
		Job job = new Job(conf,"q1_2001");
		job.setJarByClass(q1_2001.class);
	...
	public static void main(String[] args) throws Exception {
			...
			int res = ToolRunner.run(new Configuration(), new q1_2001(), args);
			System.exit(res);
	}
