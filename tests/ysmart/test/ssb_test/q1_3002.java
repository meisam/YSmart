...
package edu.osu.cse.ysmart.q1_3;
...
public class q1_3002 extends Configured implements Tool{
	...
	public static class Map extends  Mapper<Object, Text,Text,Text>{
		...
		public void map(Object key, Text value,Context context) throws IOException,InterruptedException{
			...
			if(n<12)
				line_buf[n] = line.substring(prev,i);
				if(Integer.parseInt(line_buf[11]) >= 5 && Integer.parseInt(line_buf[11]) <= 7 && Integer.parseInt(line_buf[8]) >= 26 && Integer.parseInt(line_buf[8]) <= 35){
			...
			if(n<12)
				line_buf[n] = line.substring(prev,i);
				if(Integer.parseInt(line_buf[11]) == 6 && Integer.parseInt(line_buf[4]) == 1994){
	...
	public int run(String[] args) throws Exception{
		...
		Job job = new Job(conf,"q1_3002");
		job.setJarByClass(q1_3002.class);
	...
	public static void main(String[] args) throws Exception {
			...
			int res = ToolRunner.run(new Configuration(), new q1_3002(), args);
			System.exit(res);
	}
