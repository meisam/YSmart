...
package edu.osu.cse.ysmart.countries_select_order_by;
...
public class countries_select_order_by001 extends Configured implements Tool{
	...
	public static class Map extends  Mapper<Object, Text,Text,Text>{
		...
		public void map(Object key, Text value, Context context) throws IOException,InterruptedException{
			...
			if(n<1)
				line_buf[n] = line.substring(prev,i);
			context.write(new Text(line_buf[0]+ "|" ),new Text(line_buf[0]+ "|" +line_buf[0]+ "|" ));
		}
	...
	public int run(String[] args) throws Exception{
		...
		Job job = new Job(conf, "countries_select_order_by001");
		job.setJarByClass(countries_select_order_by001.class);
	...
	public static void main(String[] args) throws Exception {
		...
		int res = ToolRunner.run(new Configuration(), new countries_select_order_by001(),args);
		System.exit(res);
	}
