...
public class tpch3query003 extends Configured implements Tool{
	...
	public static class Map extends  Mapper<Object, Text,IntWritable,Text>{
		...
		public void map(Object key, Text value,Context context) throws IOException,InterruptedException{
			...
			if(n<7)
				line_buf[n] = line.substring(prev,i);
				if(line_buf[6].compareTo("MACHINERY") == 0){

					context.write(new IntWritable(Integer.parseInt(line_buf[0])), new Text("L"+"|"+Integer.parseInt(line_buf[0])+ "|" ));
				}
			}else{
			...
			if(n<8)
				line_buf[n] = line.substring(prev,i);
				if(line_buf[4].compareTo("1995-03-26") < 0){

					context.write(new IntWritable(Integer.parseInt(line_buf[1])), new Text("R"+"|" +line_buf[4]+ "|" +Integer.parseInt(line_buf[7])+ "|" +Integer.parseInt(line_buf[0])+ "|" +Integer.parseInt(line_buf[1])+ "|" ));
				}
			}
		...
		public void reduce(IntWritable key, Iterable<Text> v, Context context) throws IOException,InterruptedException{
			...
			for(int i=0;i<al_left.size();i++){
				...
				for(int j=0;j<al_right.size();j++){
					...
					context.write(key_op, new Text(right_buf[0]+ "|" +Integer.parseInt(right_buf[1])+ "|" +Integer.parseInt(right_buf[2])+ "|" ));
				}
	...
	public int run(String[] args) throws Exception{
		...
		Job job = new Job(conf,"tpch3query003");
		job.setJarByClass(tpch3query003.class);
	...
	public static void main(String[] args) throws Exception {
			...
			int res = ToolRunner.run(new Configuration(), new tpch3query003(), args);
			System.exit(res);
	}
