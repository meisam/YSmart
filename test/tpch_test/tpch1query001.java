...
public class tpch1query001 extends Configured implements Tool{
	...
	public static class Map extends  Mapper<Object, Text,Text,Text>{
		...
		public void map(Object key, Text value, Context context) throws IOException,InterruptedException{
			...
			if(n<12)
				line_buf[n] = line.substring(prev,i);
			context.write(new Text(line_buf[0] +"|"+line_buf[1] +"|"),new Text(line_buf[2] +"|"+line_buf[3] +"|"+line_buf[4] +"|"+line_buf[5] +"|"+line_buf[6] +"|"+line_buf[7] +"|"+line_buf[8] +"|"+line_buf[9] +"|"+line_buf[10] +"|"+line_buf[11] +"|"));
		}
	...
	public int run(String[] args) throws Exception{
		...
		conf.set("mapreduce.partition.keycomparator.options","-k1,1 -k2,2 ");
		conf.set("mapreduce.map.output.key.field.separator", "|");
		Job job = new Job(conf, "tpch1query001");
		job.setJarByClass(tpch1query001.class);
	...
	public static void main(String[] args) throws Exception {
		...
		int res = ToolRunner.run(new Configuration(), new tpch1query001(),args);
		System.exit(res);
	}
