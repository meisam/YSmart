...
public class tpch10query005 extends Configured implements Tool{
	...
	public static class Map extends  Mapper<Object, Text,IntWritable,Text>{
		...
		public void setup(Context context) throws IOException, InterruptedException {
			...
			if(f_name.compareTo("CUSTOMER") == 0 )
				left = 1;
		}
		public void map(Object key, Text value,Context context) throws IOException,InterruptedException{
			...
			if(n<8)
				line_buf[n] = line.substring(prev,i);
				context.write(new IntWritable(Integer.parseInt(line_buf[0])), new Text("L"+"|" +Integer.parseInt(line_buf[0])+ "|" +line_buf[1]+ "|" +Double.parseDouble(line_buf[5])+ "|" +line_buf[4]+ "|" +line_buf[2]+ "|" +line_buf[7]+ "|" +Integer.parseInt(line_buf[3])+ "|" ));
			}else{
			...
			if(n<5)
				...
				if(line_buf[4].compareTo("1993-05-01") >= 0 && line_buf[4].compareTo("1993-08-01") < 0){
					...
					context.write(new IntWritable(Integer.parseInt(line_buf[1])), new Text("R"+"|" +Integer.parseInt(line_buf[0])+ "|" +Integer.parseInt(line_buf[1])+ "|" ));
				}
			}
		...
		public void reduce(IntWritable key, Iterable<Text> v, Context context) throws IOException,InterruptedException{
			...
			for(int i=0;i<al_left.size();i++){
				...
				for(int j=0;j<al_right.size();j++){
					...
					context.write(key_op, new Text(Integer.parseInt(left_buf[0])+ "|" +left_buf[1]+ "|" +Double.parseDouble(left_buf[2])+ "|" +left_buf[3]+ "|" +left_buf[4]+ "|" +left_buf[5]+ "|" +Integer.parseInt(left_buf[6])+ "|" +Integer.parseInt(right_buf[0])+ "|" ));
				}
	...
	public int run(String[] args) throws Exception{
		...
		Job job = new Job(conf,"tpch10query005");
		job.setJarByClass(tpch10query005.class);
	...
	public static void main(String[] args) throws Exception {
			...
			int res = ToolRunner.run(new Configuration(), new tpch10query005(), args);
			System.exit(res);
	}
