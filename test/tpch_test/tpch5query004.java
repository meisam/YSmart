...
public class tpch5query004 extends Configured implements Tool{
	...
	public static class Map extends  Mapper<Object, Text,IntWritable,Text>{
		...
		public void setup(Context context) throws IOException, InterruptedException {
			...
			if(f_name.compareTo("tpch5query005") == 0 )
				left = 1;
		}
		public void map(Object key, Text value,Context context) throws IOException,InterruptedException{
			...
			if(n<3)
				line_buf[n] = line.substring(prev,i);
				context.write(new IntWritable(Integer.parseInt(line_buf[2])), new Text("L"+"|" +line_buf[0]+ "|"+line_buf[1]+ "|"+line_buf[2]+ "|"));
			}else{
			...
			if(n<3)
				line_buf[n] = line.substring(prev,i);
				context.write(new IntWritable(Integer.parseInt(line_buf[0])), new Text("R"+"|" +line_buf[1]+ "|" +Integer.parseInt(line_buf[2])+ "|" +Integer.parseInt(line_buf[0])+ "|" ));
			}
		...
		public void reduce(IntWritable key, Iterable<Text> v, Context context) throws IOException,InterruptedException{
			...
			for(int i=0;i<al_left.size();i++){
				...
				for(int j=0;j<al_right.size();j++){
					...
					context.write(key_op, new Text(right_buf[0]+ "|" +Double.parseDouble(left_buf[0])+ "|" +Double.parseDouble(left_buf[1])+ "|" +Integer.parseInt(right_buf[1])+ "|" ));
				}
	...
	public int run(String[] args) throws Exception{
		...
		Job job = new Job(conf,"tpch5query004");
		job.setJarByClass(tpch5query004.class);
	...
	public static void main(String[] args) throws Exception {
			...
			int res = ToolRunner.run(new Configuration(), new tpch5query004(), args);
			System.exit(res);
	}
