...
public class tpch5query005 extends Configured implements Tool{
	...
	public static class Map extends  Mapper<Object, Text,Text,Text>{
		...
		public void setup(Context context) throws IOException, InterruptedException {
			...
			if(f_name.compareTo("tpch5query006") == 0 )
				left = 1;
		}
		public void map(Object key, Text value,Context context) throws IOException,InterruptedException{
			...
			if(n<4)
				line_buf[n] = line.substring(prev,i);
				context.write(new Text(Integer.parseInt(line_buf[2])+ "|" +Integer.parseInt(line_buf[3])+ "|" ), new Text("L"+"|" +line_buf[0]+ "|"+line_buf[1]+ "|"+line_buf[2]+ "|"+line_buf[3]+ "|"));
			}else{
			...
			if(n<4)
				line_buf[n] = line.substring(prev,i);
				context.write(new Text(Integer.parseInt(line_buf[0])+ "|" +Integer.parseInt(line_buf[3])+ "|" ), new Text("R"+"|" +Integer.parseInt(line_buf[3])+ "|" +Integer.parseInt(line_buf[0])+ "|" ));
			}
		...
		public void reduce(Text key, Iterable<Text> v, Context context) throws IOException,InterruptedException{
			...
			for(int i=0;i<al_left.size();i++){
				...
				for(int j=0;j<al_right.size();j++){
					...
					context.write(key_op, new Text(Double.parseDouble(left_buf[0])+ "|" +Double.parseDouble(left_buf[1])+ "|" +Integer.parseInt(right_buf[0])+ "|" ));
				}
	...
	public int run(String[] args) throws Exception{
		...
		Job job = new Job(conf,"tpch5query005");
		job.setJarByClass(tpch5query005.class);
	...
	public static void main(String[] args) throws Exception {
			...
			int res = ToolRunner.run(new Configuration(), new tpch5query005(), args);
			System.exit(res);
	}
