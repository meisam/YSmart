...
public class countries_select000 extends Configured implements Tool{
	...
	public int run(String[] args) throws Exception{
		...
		Job job = new Job(conf,"countries_select000");
		job.setJarByClass(countries_select000.class);
	...
	public static void main(String[] args) throws Exception {
			...
			int res = ToolRunner.run(new Configuration(), new countries_select000(), args);
			System.exit(res);
	}
