...
public class q2_2001 extends Configured implements Tool{
	...
	public int run(String[] args) throws Exception{
		...
		Job job = new Job(conf, "q2_2001");
		job.setJarByClass(q2_2001.class);
	...
	public static void main(String[] args) throws Exception {
		...
		int res = ToolRunner.run(new Configuration(), new q2_2001(),args);
		System.exit(res);
	}
