...
public class q3_3004 extends Configured implements Tool{
	...
	public int run(String[] args) throws Exception{
		...
		Job job = new Job(conf,"q3_3004");
		job.setJarByClass(q3_3004.class);
	...
	public static void main(String[] args) throws Exception {
			...
			int res = ToolRunner.run(new Configuration(), new q3_3004(), args);
			System.exit(res);
	}
