...
public class q2_1001001001001000 extends Configured implements Tool{
	...
	public static class Map extends  Mapper<Object, Text,Text,Text>{
		...
		public void map(Object key, Text value,Context context) throws IOException,InterruptedException{
			...
			if(n<13)
				line_buf[n] = line.substring(prev,i);
				context.write(new Text(line_buf[5]+ "|" ), new Text("L"+"|" +Double.parseDouble(line_buf[12])+ "|" +Integer.parseInt(line_buf[4])+ "|" +Integer.parseInt(line_buf[3])+ "|" +line_buf[5]+ "|" ));
			}else{
		...
		public void reduce(Text key, Iterable<Text> v, Context context) throws IOException,InterruptedException{
			...
			for(int i=0;i<al_left.size();i++){
				...
				for(int j=0;j<al_right.size();j++){
					...
					if(left_buf[3].compareTo(right_buf[1]) == 0){

						context.write(key_op, new Text(Integer.parseInt(right_buf[0])+ "|" +Double.parseDouble(left_buf[0])+ "|" +Integer.parseInt(left_buf[1])+ "|" +Integer.parseInt(left_buf[2])+ "|" ));
					}
				}
	...
	public int run(String[] args) throws Exception{
		...
		Job job = new Job(conf,"q2_1001001001001000");
		job.setJarByClass(q2_1001001001001000.class);
	...
	public static void main(String[] args) throws Exception {
			...
			int res = ToolRunner.run(new Configuration(), new q2_1001001001001000(), args);
			System.exit(res);
	}
