...
public class q4_3006 extends Configured implements Tool{
	...
	public static class Map extends  Mapper<Object, Text,Text,Text>{
		...
		public void map(Object key, Text value,Context context) throws IOException,InterruptedException{
			...
			if(n<14)
				line_buf[n] = line.substring(prev,i);
				context.write(new Text(line_buf[5]+ "|" ), new Text("L"+"|" +Double.parseDouble(line_buf[12])+ "|" +Double.parseDouble(line_buf[13])+ "|" +Integer.parseInt(line_buf[3])+ "|" +Integer.parseInt(line_buf[4])+ "|" +Integer.parseInt(line_buf[2])+ "|" +line_buf[5]+ "|" ));
			}else{
			...
			if(n<5)
				line_buf[n] = line.substring(prev,i);
				if(Integer.parseInt(line_buf[4]) == 1997 || Integer.parseInt(line_buf[4]) == 1998){
		...
		public void reduce(Text key, Iterable<Text> v, Context context) throws IOException,InterruptedException{
			...
			for(int i=0;i<al_left.size();i++){
				...
				for(int j=0;j<al_right.size();j++){
					...
					if(Integer.parseInt(right_buf[0]) == 1997 || Integer.parseInt(right_buf[0]) == 1998){

						context.write(key_op, new Text(Integer.parseInt(right_buf[0])+ "|" +Double.parseDouble(left_buf[0])+ "|" +Double.parseDouble(left_buf[1])+ "|" +Integer.parseInt(left_buf[2])+ "|" +Integer.parseInt(left_buf[3])+ "|" +Integer.parseInt(left_buf[4])+ "|" ));
					}
				}
	...
	public int run(String[] args) throws Exception{
		...
		Job job = new Job(conf,"q4_3006");
		job.setJarByClass(q4_3006.class);
	...
	public static void main(String[] args) throws Exception {
			...
			int res = ToolRunner.run(new Configuration(), new q4_3006(), args);
			System.exit(res);
	}
