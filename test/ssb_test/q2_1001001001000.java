...
public class q2_1001001001000 extends Configured implements Tool{
	...
	public static class Map extends  Mapper<Object, Text,IntWritable,Text>{
		...
		public void setup(Context context) throws IOException, InterruptedException {
			...
			if(f_name.compareTo("q2_1001001001001") == 0 )
				left = 1;
		}
		public void map(Object key, Text value,Context context) throws IOException,InterruptedException{
			...
			if(n<5)
				line_buf[n] = line.substring(prev,i);
				if(line_buf[3].compareTo("MFGR#12") == 0){
	...
	public int run(String[] args) throws Exception{
		...
		Job job = new Job(conf,"q2_1001001001000");
		job.setJarByClass(q2_1001001001000.class);
	...
	public static void main(String[] args) throws Exception {
			...
			int res = ToolRunner.run(new Configuration(), new q2_1001001001000(), args);
			System.exit(res);
	}
