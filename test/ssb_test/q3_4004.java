...
public class q3_4004 extends Configured implements Tool{
		...
		public void reduce(IntWritable key, Iterable<Text> v, Context context) throws IOException,InterruptedException{
			...
			for(int i=0;i<al_left.size();i++){
				...
				for(int j=0;j<al_right.size();j++){
					...
					if(left_buf[0].compareTo("UNITED KI1") == 0 || left_buf[0].compareTo("UNITED KI5") == 0 && right_buf[0].compareTo("UNITED KI1") == 0 || right_buf[0].compareTo("UNITED KI5") == 0){

						context.write(key_op, new Text(left_buf[0]+ "|" +right_buf[0]+ "|" +Double.parseDouble(left_buf[1])+ "|" +left_buf[2]+ "|" ));
					}
				}
	...
	public int run(String[] args) throws Exception{
		...
		Job job = new Job(conf,"q3_4004");
		job.setJarByClass(q3_4004.class);
	...
	public static void main(String[] args) throws Exception {
			...
			int res = ToolRunner.run(new Configuration(), new q3_4004(), args);
			System.exit(res);
	}
