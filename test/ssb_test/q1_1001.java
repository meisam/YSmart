...
public class q1_1001 extends Configured implements Tool{
	...
	public static class Map extends Mapper<Object, Text,Text,Text>{
		...
		public void map(Object key, Text value, Context context) throws IOException,InterruptedException{
			...
			if(adv_gb_output[0].containsKey(hash_key)){
				Double sum_tmp = (double)((Double.parseDouble(line_buf[1]) * Integer.parseInt(line_buf[2])));
				sum_tmp += adv_gb_output[0].get(hash_key);
				adv_gb_output[0].put(hash_key, sum_tmp);
			}else{
				adv_gb_output[0].put(hash_key,(double)((Double.parseDouble(line_buf[1]) * Integer.parseInt(line_buf[2]))));
			}
		}
	...
	public int run(String[] args) throws Exception{
		...
		Job job = new Job(conf,"q1_1001");
		job.setJarByClass(q1_1001.class);
	...
	public static void main(String[] args) throws Exception {
			...
			int res = ToolRunner.run(new Configuration(), new q1_1001(), args);
			System.exit(res);
	}
