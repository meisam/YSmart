...
public class q3_3003 extends Configured implements Tool{
	...
	public int run(String[] args) throws Exception{
		...
		Job job = new Job(conf,"q3_3003");
		job.setJarByClass(q3_3003.class);
	...
	public static void main(String[] args) throws Exception {
			...
			int res = ToolRunner.run(new Configuration(), new q3_3003(), args);
			System.exit(res);
	}
