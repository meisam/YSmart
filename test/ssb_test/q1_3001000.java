...
public class q1_3001000 extends Configured implements Tool{
	...
	public int run(String[] args) throws Exception{
		...
		Job job = new Job(conf,"q1_3001000");
		job.setJarByClass(q1_3001000.class);
	...
	public static void main(String[] args) throws Exception {
			...
			int res = ToolRunner.run(new Configuration(), new q1_3001000(), args);
			System.exit(res);
	}
